...
local KNOWN_NOT_BYTE_IDENTICAL = {
  ...
  ["nulls.json"] =
    "carries id and parent, which are dropped by design (4.1); the explicit " ..
    "null text.link/href are also omitted, since the writer emits those keys " ..
    "only when a link exists",
  ["has-children.json"] =
    "list-response envelope is normalized to a bare array (6.1); id is " ..
    "dropped by design (4.1) and has_children has no AST carrier (6.3)",
