...
---A definition-list item is a POSITIONAL PAIR, not a record: pandoc represents
---it as a two-element array of `{term, definitions}`. Verified against pandoc
---3.11 -- for `dl.content[1]`, `#item == 2` and `item.term` is nil. Modelling
---it as a class with required `term`/`data` fields made every literal
---`{ term, { definition } }` report `missing-fields`.
---@alias DefinitionListItem [InlinesLike, BlocksLike[]]
