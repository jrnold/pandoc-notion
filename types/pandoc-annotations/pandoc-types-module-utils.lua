...
---@field blocks_to_inlines fun(blocks: BlocksLike, sep?: InlinesLike): Inlines Squash a list of blocks into a list of inlines.
...
---@field make_sections fun(number_sections: boolean, baselevel: integer|nil, blocks: BlocksLike): Blocks Converts a list of Block elements into sections. `Div`s will be created beginning at each `Header` and containing following content until the next Header of comparable level.
